...
| Tipo | Qué es | Ejemplo |
|---|---|---|
| `assignment` | El comportamiento completo de un NPC, el que se asigna con `/puppeteer assign`. | `guardia:` <br>`  type: assignment` |
...
| `define <nombre> <valor>` | Guarda un valor para el resto de la secuencia. | `- define modo hostil` |
